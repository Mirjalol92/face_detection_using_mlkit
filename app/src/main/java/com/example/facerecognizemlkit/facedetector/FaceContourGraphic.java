...
public class FaceContourGraphic extends com.example.facerecognizemlkit.facedetector.GraphicOverlay.Graphic {
  ...
  public FaceContourGraphic(com.example.facerecognizemlkit.facedetector.GraphicOverlay overlay) {
    super(overlay);
